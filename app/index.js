...
var NgJadeLessGenerator = module.exports = function NgJadeLessGenerator(args, options, config) {
...
util.inherits(NgJadeLessGenerator, yeoman.generators.Base);

NgJadeLessGenerator.prototype.askFor = function askFor() {
  var cb = this.async();
...
NgJadeLessGenerator.prototype.app = function app() {
  this.mkdir('app');
...
NgJadeLessGenerator.prototype.projectfiles = function projectfiles() {
